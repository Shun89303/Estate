...
export const MOCK_CONTENTS: ContentItem[] = [
	{
		...
		cta: {
			...
			subtitle: "Ready to start your investment journey?",
			body: "Our property experts will help you find the perfect match. No fees, no pressure — just honest advice.",
...

	{
		...
		cta: {
			title: "FREE CONSULTATION",
			subtitle: "Like what you see? Let's find yours.",
			body: "Our property experts are ready to help you find your dream home or investment. Zero obligation.",
			buttonText: "Talk to an expert",
			buttonLink: "/",
		},
		relatedVideos: [
